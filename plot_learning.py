...
def main():
    ...
    filename = "generate_" + options.sequence + "_" + options.epoch + ".pdf"
    
    #executive area
    filename_executive_a_mu = "./" + FOLDERNAME_MODEL + "/executive" + "/a_mu_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_executive_a_sigma = "./" + FOLDERNAME_MODEL + "/executive" + "/a_sigma_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    #associative area
    filename_associative_in_p_mu = "./" + FOLDERNAME_GENERATE + "/associative" + "/in_p_mu_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_associative_in_p_sigma = "./" + FOLDERNAME_GENERATE + "/associative" + "/in_p_sigma_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_associative_a_mu = "./" + FOLDERNAME_MODEL + "/associative" + "/a_mu_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_associative_a_sigma = "./" + FOLDERNAME_MODEL + "/associative" + "/a_sigma_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    #proprioceptive area
    filename_proprioceptive_in_p_mu = "./" + FOLDERNAME_GENERATE + "/proprioceptive" + "/in_p_mu_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_proprioceptive_in_p_sigma = "./" + FOLDERNAME_GENERATE + "/proprioceptive" + "/in_p_sigma_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_proprioceptive_a_mu = "./" + FOLDERNAME_MODEL + "/proprioceptive" + "/a_mu_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_proprioceptive_a_sigma = "./" + FOLDERNAME_MODEL + "/proprioceptive" + "/a_sigma_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    #exteroceptive area
    filename_exteroceptive_in_p_mu = "./" + FOLDERNAME_GENERATE + "/exteroceptive" + "/in_p_mu_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_exteroceptive_in_p_sigma = "./" + FOLDERNAME_GENERATE + "/exteroceptive" + "/in_p_sigma_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_exteroceptive_a_mu = "./" + FOLDERNAME_MODEL + "/exteroceptive" + "/a_mu_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_exteroceptive_a_sigma = "./" + FOLDERNAME_MODEL + "/exteroceptive" + "/a_sigma_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    #output
    filename_output_proprio = "./" + FOLDERNAME_GENERATE + "/out_proprio" + "/output_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_output_extero = "./" + FOLDERNAME_GENERATE + "/out_extero" + "/output_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    #target
    filename_target_proprio = "./" + FOLDERNAME_GENERATE + "/out_proprio" + "/target_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    filename_target_extero = "./" + FOLDERNAME_GENERATE + "/out_extero" + "/target_{:0>7}".format(options.sequence) + "_{:0>7}".format(options.epoch) + ".txt"
    #filename_target = "./target" + "/target_{:0>7}".format(options.sequence) + ".txt"
    
    plot = plot_rnn(filename, filename_executive_a_mu,  filename_executive_a_sigma, filename_associative_in_p_mu, filename_associative_in_p_sigma, filename_associative_a_mu, filename_associative_a_sigma, filename_proprioceptive_in_p_mu, filename_proprioceptive_in_p_sigma,  filename_proprioceptive_a_mu,  filename_proprioceptive_a_sigma, filename_exteroceptive_in_p_mu, filename_exteroceptive_in_p_sigma, filename_exteroceptive_a_mu, filename_exteroceptive_a_sigma, filename_output_proprio, filename_output_extero, filename_target_proprio, filename_target_extero)
